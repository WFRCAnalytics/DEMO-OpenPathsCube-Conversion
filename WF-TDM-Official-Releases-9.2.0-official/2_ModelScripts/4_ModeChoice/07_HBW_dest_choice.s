...
RUN PGM=MATRIX   MSG='Mode Choice 7: calculate productions by market segment - HBW'
 ...
 zonemsg=@ZoneMsgRate@          ;reduces print messages in TPP DOS. (i.e. runs faster).
    ...
    ZDATI[7]='@ParentDir@@ScenarioDir@2_Tripgen\pa.dbf'           ;productions/attractions by TAZ
...
RUN PGM=MATRIX   MSG='Mode Choice 7: calculate utilities - @veh@ - @inc@ - iteration @iterate@'
 ...
 zonemsg=@ZoneMsgRate@          ;reduces print messages in TPP DOS. (i.e. runs faster).
  ...
  ZDATI[1] = '@ParentDir@@ScenarioDir@2_Tripgen\pa.dbf'     	;productions/attractions by TAZ
  ZDATI[2] = '@ParentDir@@ScenarioDir@0_InputProcessing\SE_File_@RID@.dbf'		;employment by TAZ
...
RUN PGM=MATRIX   MSG='Mode Choice 7: copy and rename HBW-Veh-Inc matrices from final iteration'
 ...
 zonemsg=@ZoneMsgRate@          ;reduces print messages in TPP DOS. (i.e. runs faster).
    ...
    MATO[1] = '@ParentDir@@ScenarioDir@Temp\4_ModeChoice\pa_HBW_0veh_lo.mtx', 
        mo=112-113, 212-213, 312-313, 311,
        name=trips100    ,
             trips       ,
             Tel_trips100,
             Tel_trips   ,
    ...
    MATO[2] = '@ParentDir@@ScenarioDir@Temp\4_ModeChoice\pa_HBW_0veh_hi.mtx', 
        mo=122-123, 222-223, 322-323, 321,
        name=trips100    ,
             trips       ,
             Tel_trips100,
             Tel_trips   ,
    ...
    MATO[3] = '@ParentDir@@ScenarioDir@Temp\4_ModeChoice\pa_HBW_1veh_lo.mtx', 
        mo=132-133, 232-233, 332-333, 331,
        name=trips100    ,
             trips       ,
             Tel_trips100,
             Tel_trips   ,
    ...
    MATO[4] = '@ParentDir@@ScenarioDir@Temp\4_ModeChoice\pa_HBW_1veh_hi.mtx', 
        mo=142-143, 242-243, 342-343, 341,
        name=trips100    ,
             trips       ,
             Tel_trips100,
             Tel_trips   ,
    ...
    MATO[5] = '@ParentDir@@ScenarioDir@Temp\4_ModeChoice\pa_HBW_2veh_lo_noXI.mtx', 
        mo=152-153, 252-253, 352-353, 351,
        name=trips100    ,
             trips       ,
             Tel_trips100,
             Tel_trips   ,
    ...
    MATO[6] = '@ParentDir@@ScenarioDir@Temp\4_ModeChoice\pa_HBW_2veh_hi_noXI.mtx', 
        mo=162-163, 262-263, 362-363, 361,
        name=trips100    ,
             trips       ,
             Tel_trips100,
             Tel_trips   ,
    ...
    MATO[7] = '@ParentDir@@ScenarioDir@Temp\4_ModeChoice\pa_HBW_total_noXI.mtx',
        mo=172-173, 272-273, 372-373, 371,
        name=trips100    ,
             trips       ,
             Tel_trips100,
             Tel_trips   ,
    ...
    ;Total HBW_0veh_lo
    mw[311] = mi.1.share   
    mw[312] = mi.1.trips100
    mw[313] = mi.1.trips   
    
    ;Total HBW_0veh_hi
    mw[321] = mi.2.share   
    mw[322] = mi.2.trips100
    mw[323] = mi.2.trips   
    
    
    ;Total HBW_1veh_lo
    mw[331] = mi.3.share   
    mw[332] = mi.3.trips100
    mw[333] = mi.3.trips   
    
    ;Total HBW_1veh_hi
    mw[341] = mi.4.share   
    mw[342] = mi.4.trips100
    mw[343] = mi.4.trips   

    
    ;Total HBW_2veh_lo
    mw[351] = mi.5.share   
    mw[352] = mi.5.trips100
    mw[353] = mi.5.trips   
    
    ;Total HBW_2veh_hi
    mw[361] = mi.6.share   
    mw[362] = mi.6.trips100
    mw[363] = mi.6.trips   

    ;Total HBW_total
    mw[372] = mi.7.trips100
    mw[373] = mi.7.trips   
    ...
    ;calculate telecommite trips
    JLOOP
        
        ;trips 100
        mw[212] = mw[312] * zi.1.PctTelHBW[j]    ;HBW_0veh_lo
        mw[222] = mw[322] * zi.1.PctTelHBW[j]    ;HBW_0veh_hi
        mw[232] = mw[332] * zi.1.PctTelHBW[j]    ;HBW_1veh_lo
        mw[242] = mw[342] * zi.1.PctTelHBW[j]    ;HBW_1veh_hi
        mw[252] = mw[352] * zi.1.PctTelHBW[j]    ;HBW_2veh_lo
        mw[262] = mw[362] * zi.1.PctTelHBW[j]    ;HBW_2veh_hi
        mw[272] = mw[372] * zi.1.PctTelHBW[j]    ;HBW total
        
        ;trips
        mw[213] = mw[313] * zi.1.PctTelHBW[j]    ;HBW_0veh_lo
        mw[223] = mw[323] * zi.1.PctTelHBW[j]    ;HBW_0veh_hi
        mw[233] = mw[333] * zi.1.PctTelHBW[j]    ;HBW_1veh_lo
        mw[243] = mw[343] * zi.1.PctTelHBW[j]    ;HBW_1veh_hi
        mw[253] = mw[353] * zi.1.PctTelHBW[j]    ;HBW_2veh_lo
        mw[263] = mw[363] * zi.1.PctTelHBW[j]    ;HBW_2veh_hi
        mw[273] = mw[373] * zi.1.PctTelHBW[j]    ;HBW total  
    ...
    ;HBW (Total minus telecommute)
    ;trips 100
    mw[112] = mw[312] - mw[212]    ;HBW_0veh_lo
    mw[122] = mw[322] - mw[222]    ;HBW_0veh_hi
    mw[132] = mw[332] - mw[232]    ;HBW_1veh_lo
    mw[142] = mw[342] - mw[242]    ;HBW_1veh_hi
    mw[152] = mw[352] - mw[252]    ;HBW_2veh_lo
    mw[162] = mw[362] - mw[262]    ;HBW_2veh_hi
    mw[172] = mw[372] - mw[272]    ;HBW total  
    
    ;trips
    mw[113] = mw[313] - mw[213]    ;HBW_0veh_lo
    mw[123] = mw[323] - mw[223]    ;HBW_0veh_hi
    mw[133] = mw[333] - mw[233]    ;HBW_1veh_lo
    mw[143] = mw[343] - mw[243]    ;HBW_1veh_hi
    mw[153] = mw[353] - mw[253]    ;HBW_2veh_lo
    mw[163] = mw[363] - mw[263]    ;HBW_2veh_hi
    mw[173] = mw[373] - mw[273]    ;HBW total  
    
    
    ;sum HBW minus telecommuting by vehicle segment
    mw[101] = mw[113] + mw[123]     ;HBW0
    mw[102] = mw[133] + mw[143]     ;HBW1
    mw[103] = mw[153] + mw[163]     ;HBW2
